...
public class VoiceCallActivity extends CallActivity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//EMChatManager.getInstance().isv
		//HXSDKHelper.getInstance().isVoiceCalling = true;//这里设置是通知栏类型
		...
		// 设置通话人 nickTextView.setText(username);
		nickTextView.setText("游客");
